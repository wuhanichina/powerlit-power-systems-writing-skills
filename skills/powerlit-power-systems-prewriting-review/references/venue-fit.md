...
- only an algorithmic wrapper;
- weak physical explanation;
- evidence too thin for engineering applicability.
...
- contribution is mainly application, packaging, or empirical tuning;
- method lacks mathematical clarity or baseline depth.
...
- one hard claim;
- one compact derivation, counterexample, formulation, or algorithmic trick;
- minimal decisive evidence.

Risk:

- multiple contributions;
- full-paper scope compressed into four pages.
