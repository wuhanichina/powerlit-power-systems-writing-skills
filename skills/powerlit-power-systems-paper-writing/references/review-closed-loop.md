...
3. the draft has passed claim, reader-burden, cut, rhythm, and anti-AI-language passes;
...
3. Rerun the relevant review check mentally against the repaired section.
4. If the issue remains because information is missing, do not hide it. Return a bounded draft and a short note naming the missing model, evidence, baseline, or citation requirement.
